...
public class BackwardBigramModel {
	...
	System.out.println("For forward model");
	
	
	
	BigramModel fmodel = new BigramModel();
	System.out.println("Training...");
	fmodel.train(trainSentences);
	// Test on training data using test and test2
	fmodel.test(trainSentences);
	fmodel.test2(trainSentences);
	System.out.println("Testing...");
	// Test on test data using test and test2
	fmodel.test(testSentences);
	fmodel.test2(testSentences);
	fmodel.print();
